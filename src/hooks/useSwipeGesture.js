...
/**
 * Horizontal swipe gesture via Pointer Events (React synthetic handlers).
 * Mirrors the proven inline implementation in QuickTodosPage: the consumer must
 * spread `handlers` onto the element the finger touches, and that element (or an
 * ancestor) needs `touch-action: pan-y` so iOS reserves horizontal panning for JS.
 */
