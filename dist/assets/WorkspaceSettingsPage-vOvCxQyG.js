import{d as a,j as e}from"./vendor-notes-editor-C-RICP77.js";import{U as he,O as E,_ as Ee,V as $e,I as V,v as Me}from"./index-Cp2VZOyn.js";const Ue="BHQ5iYlti3RadbzjdBxK_qNOee1ljQ77UJx5N6eG4Cf2_EjSUtHXeki2Ej914Pstf0VQT4Mt4c4kNnfC4IBgTlI";function Ae(i){const h="=".repeat((4-i.length%4)%4),n=(i+h).replace(/-/g,"+").replace(/_/g,"/");return Uint8Array.from(atob(n),c=>c.charCodeAt(0))}function Be(){const{userId:i,activeWorkspaceId:h}=he(),[n,c]=a.useState(!1),[p,g]=a.useState("default"),[z,f]=a.useState(!1),[W,N]=a.useState(!1);a.useEffect(()=>{const l="serviceWorker"in navigator&&"PushManager"in window&&!0;c(l),l&&g(Notification.permission)},[]),a.useEffect(()=>{!n||!i||navigator.serviceWorker.ready.then(async l=>{const u=await l.pushManager.getSubscription();f(!!u)}).catch(()=>{})},[n,i]);const F=a.useCallback(async()=>{if(!(!n||!i||!h)){N(!0);try{const l=await Notification.requestPermission();if(g(l),l!=="granted")return;const u=await navigator.serviceWorker.ready;let x=await u.pushManager.getSubscription();x||(x=await u.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:Ae(Ue)}));const{endpoint:w,keys:$}=x.toJSON();await E.from("push_subscriptions").upsert({user_id:i,workspace_id:h,endpoint:w,p256dh:$.p256dh,auth:$.auth},{onConflict:"user_id,endpoint"}),f(!0)}catch(l){console.error("Push subscribe:",l)}finally{N(!1)}}},[n,i,h]),I=a.useCallback(async()=>{if(!(!n||!i)){N(!0);try{const u=await(await navigator.serviceWorker.ready).pushManager.getSubscription();if(u){const{endpoint:x}=u.toJSON();await u.unsubscribe(),await E.from("push_subscriptions").delete().eq("user_id",i).eq("endpoint",x)}f(!1)}catch(l){console.error("Push unsubscribe:",l)}finally{N(!1)}}},[n,i]);return{supported:n,permission:p,subscribed:z,loading:W,subscribe:F,unsubscribe:I}}const ce={owner:"#f59e0b",admin:"#3b82f6",member:"#22c55e",viewer:"#8b95a5"},Ve=[{id:"dashboard",label:"Přehled"},{id:"tasks",label:"Úkoly"},{id:"quick-todos",label:"Rychlý seznam"},{id:"projects",label:"Projekty"},{id:"timeline",label:"Plán"},{id:"notes",label:"Poznámky"}],Fe=[{id:"account",label:"Účet",icon:"user"},{id:"workspace",label:"Workspace",icon:"settings"},{id:"members",label:"Členové",icon:"users"},{id:"notifications",label:"Notifikace",icon:"bell"},{id:"app",label:"Aplikace",icon:"sliders-horizontal"}],pe={email_task_reminders:!0,email_daily_digest:!0,push_task_reminders:!0,push_daily_digest:!0,digest_hour:8};function De(i){return ce[i]||ce.member}function d({label:i,title:h,description:n,icon:c,tone:p="default",children:g,action:z,className:f=""}){const W=p==="danger"?{borderColor:"rgba(239,68,68,.28)",background:"linear-gradient(180deg, rgba(239,68,68,.045), var(--surface))"}:p==="accent"?{borderColor:"color-mix(in srgb, var(--accent) 28%, var(--border-soft))",background:"linear-gradient(180deg, var(--accent-soft), var(--surface) 58%)"}:null;return e.jsxs("section",{className:`ws-card ${f}`,style:W||void 0,children:[e.jsxs("div",{className:"ws-card-head",children:[e.jsxs("div",{className:"ws-card-title-wrap",children:[c&&e.jsx("span",{className:`ws-card-icon ${p}`,children:e.jsx(V,{name:c,size:15,color:"currentColor",strokeWidth:2})}),e.jsxs("div",{children:[i&&e.jsx("div",{className:`ws-section-label ${p}`,children:i}),h&&e.jsx("div",{className:"ws-card-title",children:h}),n&&e.jsx("div",{className:"ws-card-desc",children:n})]})]}),z&&e.jsx("div",{className:"ws-card-action",children:z})]}),g&&e.jsx("div",{className:"ws-card-body",children:g})]})}function xe({children:i,tone:h="default"}){return e.jsx("span",{className:`ws-meta-pill ${h}`,children:i})}function me({children:i}){return e.jsx("div",{className:"ws-form-hint",children:i})}function Ke({initialTab:i="workspace"}){const{workspaces:h,activeWorkspaceId:n,workspaceMembers:c,workspaceRole:p,userId:g,renameWorkspace:z,updateMemberRole:f,removeMember:W,leaveWorkspace:N,generateInviteLink:F,fetchWorkspaceInvites:I,revokeInvite:l,setPage:u,isMobile:x,userEmail:w,logout:$,updateProfileDisplayName:ge,dk:ue,setDk:be,uiSettings:v,updateUiSettings:S,accentThemes:fe,isSystemAdmin:we}=he(),r=Ee(),D=$e(),m=Be(),C=h.find(t=>t.id===n),P=c.find(t=>t.userId===g),[_,Q]=a.useState(i),[ve,M]=a.useState(!1),[L,H]=a.useState(C?.name??""),[K,Z]=a.useState([]),[Y,ye]=a.useState("member"),[q,J]=a.useState(""),[ke,X]=a.useState(!1),[O,ee]=a.useState(P?.displayName||""),[G,te]=a.useState(!1),[je,ze]=a.useState(!1),[y,se]=a.useState(pe),[ae,ie]=a.useState(!1),[b,R]=a.useState(null),U=p==="owner"||p==="admin",A=p==="owner";a.useEffect(()=>{U&&(X(!0),I().then(Z).catch(()=>{}).finally(()=>X(!1)))},[n,U,I]),a.useEffect(()=>{Q(i)},[i]),a.useEffect(()=>{H(C?.name??"")},[C?.name]),a.useEffect(()=>{ee(P?.displayName||"")},[P?.displayName]),a.useEffect(()=>{g&&E.from("notification_preferences").select("*").eq("user_id",g).single().then(({data:t})=>{t&&se({...pe,...t})})},[g]);const re=async t=>{const s={...y,...t};se(s),ie(!0);const{error:o}=await E.from("notification_preferences").upsert({user_id:g,...s,updated_at:new Date().toISOString()},{onConflict:"user_id"});ie(!1),o&&r("Nepodařilo se uložit nastavení","error")},ne=async()=>{if(O.trim()){te(!0);try{await ge(O.trim()),r("Jméno uloženo","success")}catch(t){r(t.message||"Chyba","error")}finally{te(!1)}}},Ne=async()=>{const{error:t}=await E.auth.resetPasswordForEmail(w,{redirectTo:`${window.location.origin}?reset=1`});if(t){r(t.message||"Chyba","error");return}ze(!0),r("Odkaz pro reset hesla odeslán na email","success")},Se=async()=>{await D("Odhlásit se?")&&await $()},oe=async()=>{if(L.trim())try{await z(L.trim()),M(!1),r("Přejmenováno","success")}catch(t){r(t.message||"Chyba","error")}},Ce=async(t,s)=>{try{await f(t,s),r("Role aktualizována","success")}catch(o){r(o.message||"Chyba","error")}},le=async(t,s=!1)=>{if(!(!s&&!await D(`Odebrat ${t.email||t.userId.slice(0,8)} z workspace?`)))try{await W(t.userId),r("Člen odebrán","success")}catch(o){r(o.message||"Chyba","error")}},de=async(t=!1)=>{if(!(!t&&!await D("Opravdu chceš opustit tento workspace?")))try{await N(),u("dashboard"),r("Opustil jsi workspace","success")}catch(s){r(s.message||"Chyba","error")}},Pe=async()=>{try{const t=await F(Y);J(t);const s=await I();Z(s),r("Odkaz vygenerován","success")}catch(t){r(t.message||"Chyba","error")}},_e=async t=>{try{await l(t),Z(s=>s.filter(o=>o.id!==t)),r("Pozvánka zrušena","success")}catch(s){r(s.message||"Chyba","error")}},We=t=>t.displayName||t.email||`${t.userId.slice(0,8)}…`,Ie=t=>(t.displayName||t.email||t.userId||"?").slice(0,2).toUpperCase(),Oe=(P?.displayName||w||"?").slice(0,2).toUpperCase(),T={width:"100%",padding:x?"11px 12px":"9px 12px",borderRadius:11,border:"1px solid var(--border-soft)",background:"var(--bg-2)",color:"var(--text)",fontSize:x?16:13,outline:"none"},k={fontSize:13,color:"var(--text-3)",lineHeight:1.55},B=t=>({padding:x?"9px 11px":"8px 11px",borderRadius:10,border:`1px solid ${t?"color-mix(in srgb, var(--accent) 38%, transparent)":"var(--border-soft)"}`,background:t?"var(--accent-soft)":"var(--bg-2)",color:t?"var(--accent)":"var(--text-2)",fontSize:12,fontWeight:t?850:650}),Re=t=>({width:46,height:26,borderRadius:999,border:`1px solid ${t?"color-mix(in srgb, var(--accent) 36%, transparent)":"var(--border-soft)"}`,background:t?"var(--accent-soft)":"var(--bg-2)",position:"relative",padding:0,flexShrink:0}),Te=t=>({position:"absolute",top:3,left:t?23:3,width:18,height:18,borderRadius:"50%",background:t?"var(--accent)":"var(--text-3)",transition:"left .16s ease, background .16s ease"});return e.jsxs("div",{className:"content workspace-settings-page",children:[e.jsx("style",{children:`
